...
export default function CallToActionButton() {
    ...
    return (
        <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="inline-flex items-center justify-center px-10 py-5 rounded-full bg-gradient-to-r from-yellow-500 via-yellow-400 to-yellow-500 text-gray-900 font-bold text-lg shadow-[0_0_30px_rgba(234,179,8,0.3)] hover:shadow-[0_0_50px_rgba(234,179,8,0.5)] transition-all duration-300 relative overflow-hidden group"
        >
